...
//           <select id="category" ref={categoryEl} className="border rounded p-2 w-full">
...
//         <div className="flex-1">
//           <label htmlFor="amount" className="block font-semibold mb-1">Number of Questions</label>
//           <input
//             type="number"
//             id="amount"
//             min="1"
...
//         <button className="h-10 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 mt-2 md:mt-0">
//           Generate
//         </button>
//       </form>
...
//           Create Flashcard
//         </button>
//         <button onClick={() => setShuffle((prev) => !prev)} className="px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700">
...
//       {/* Flashcards */}
//       <h1 className="text-center text-2xl font-bold mb-4">Study Flashcards</h1>
//       {filteredCards.length > 0 ? (
//         <FlipFlashCardList flashcards={filteredCards} />
//       ) : (
//         <p className="text-center text-gray-500">No flashcards found. Select a category or create some!</p>
//       )}
